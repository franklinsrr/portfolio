<template>
    <div id="console" class="z-30">

      <!-- bolts -->
      <img id="corner" src="/bolt-up-left.svg" alt="" class="absolute top-2 left-2 opacity-70">
      <img id="corner"  src="/bolt-up-right.svg" alt="" class="absolute top-2 right-2 opacity-70">
      <img id="corner"  src="/bolt-down-left.svg" alt="" class="absolute bottom-2 left-2 opacity-70">
      <img id="corner"  src="/bolt-down-right.svg" alt="" class="absolute bottom-2 right-2 opacity-70">


      <!-- Game Screen -->
      <div id="game-screen" ref="gameScreen"></div>

      <button id="start-button" class="font-fire-code-retina" @click="startGame">start-game</button>

      <!-- Game Over -->
      <div id="game-over" class="hidden">
        <span class="font-fire-code-retina text-greenfy bg-bluefy-dark h-12 flex items-center justify-center">GAME OVER!</span>
        <button class="font-fire-code-retina text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white" @click="startAgain">start-again</button>
      </div>

      <div id="congrats" class="hidden">
        <span class="font-fire-code-retina text-greenfy bg-bluefy-dark h-12 flex items-center justify-center">WELL DONE!</span>
        <button class="font-fire-code-retina text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white" @click="startAgain">play-again</button>
      </div>
      ...
      <div id="console-menu" class="h-full flex flex-col items-end justify-between">
        ...
        <div id="instructions" class="font-fire-code-retina text-sm text-white">
        ...
        <div id="score-board" class="w-full flex flex-col pl-5">
          <p class="font-fire-code-retina text-white pt-5">// food left</p>
        ...
        <!-- skip -->
        <NuxtLink id="skip-btn" to="/about-me" class="font-fire-code-retina flex hover:bg-white/20">
          skip
        </NuxtLink>

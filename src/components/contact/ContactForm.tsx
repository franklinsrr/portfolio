...
const ContactForm: FC = () => {
    ...
    const handleChangeInput = (event: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        const updatedForm = { ...form, [name]: event.target.value } as Partial<IContactForm>;
        setForm(updatedForm);
    }
    ...
    return <form className="max-w-96 lg:py-40 py-10 w-full flex flex-col gap-6">
        <Input
            name="name"
            type="text"
            required

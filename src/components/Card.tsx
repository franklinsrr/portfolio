  ...
  return (
    <section className="">
      <div className="flex gap-3 relative top-[20px]">
        ...
        <h3 className="text-secondary-gray font-custom-normal-size font-fire-code-retina">
          // {project.title}
        </h3>
      </div>
      <section className="relative w-[100%] max-w-[370px] min-w-[291px] overflow-hidden">
        ...
        <img
          src={project.image}
          alt="test"
          className="w-full relative top-[30px] h-[197px] border-x-[1px] border-x-linescolor border-t-[1px] border-t-linescolor rounded-t-2xl"
        />

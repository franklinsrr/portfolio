<template>
  <div id="console" class="z-30">
    ...
    <button id="start-button" class="font-fire-code-retina" @click="startGame">
      start-game
    </button>
    ...
    <div id="game-over" class="hidden">
      <span
        class="font-fire-code-retina text-greenfy bg-bluefy-dark h-12 flex items-center justify-center"
        >GAME OVER!</span
      >
      <button
        class="font-fire-code-retina text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white"
        @click="startAgain"
      >
        start-again
      </button>

    ...
    return (
        <div className="relative">
            ...
            <div id="game-over" className="hidden">
                <span className="font-fire-code-retina text-greenfy bg-bluefy-dark h-12 flex items-center justify-center">GAME OVER!</span>
                <button className="font-fire-code-retina text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white" onClick={handleStartAgain}>start-again</button>
                </div>
            <div id="congrats" className="hidden">
                <span className="font-fire-code-retina text-greenfy bg-bluefy-dark h-12 flex items-center justify-center">WELL DONE!</span>
                <button className="font-fire-code-retina text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white">play-again</button>
            </div>
        </div>
    )
}
